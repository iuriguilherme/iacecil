...
As diretivas de configuração que forem usadas lá serão carregadas por
este arquivo aqui. Não há uma boa razão para alterar os valores padrão
deste arquivo.
Veja o arquivo de referência example.env no diretório doc para aprender
a criar um arquivo .env
Também é possível usar variáveis de ambiente do jeito clássico do
sistema operacional, estas variáveis vão ser usadas preferencialmente e
sobrescrever até mesmo o arquivo .env
!!!!!!!!!!!!!!! ATENÇÃO !!!!!!!!!!!!!!!

WARNING: Do not edit this file. Use the .env file or regular 
environment variables. The full explanation to such a request lies in 
the above portuguese notice, please translate it to your local 
language, thanks.
...
# ~ Using default configuration instead.""")
    ...
    class BaseConfig(BaseSettings):
        ...
        Tudo o que deve ser alterado independemente do ambiente deveria
		estar aqui.  
        Arquivos .env, config.ini, user.cfg, diretório instance/ e
        demais configurações específicas do ambiente não devem estar
        aqui.  
        Somente configurações comuns para todas versões de ia.cecil
        devem constar neste arquivo e mantidas sob versionamento.  
